...
namespace EES.Infrastructure.Commons
{
    ...
    public class ApiResponseBase
    {
        ...
        public static ApiResponseBase Fail(BusinessError error, object? data = null) => new()
        {
            Code = (int)error,
        ...
        public bool Equals(ApiResponseBase? apiResponse)
        {
            return apiResponse != null && this.Code == apiResponse.Code && this.Message == apiResponse.Message;
        }
    }
